...
def create_model(request):
    ...
    try:
        ...
        command = [
            ...
            str(skinny),
            str(overweight),
            str(chosenClothSelection),
            str(chosenPreset),
            str(request.user.username),
            str(output_directory),
            str(results.get("Eye Distance", -1)),
            str(results.get("Eye Width", -1)),
            str(results.get("Eye Height", -1)),
            str(results.get("Nose Width", -1)),
            str(results.get("Nose Height", -1)),
            str(results.get("Lip Width", -1)),
            str(results.get("Chin Width", -1)),
            str(results.get("Chin Height", -1)),
            str(results.get("Jaw Width", -1)),
        ]
