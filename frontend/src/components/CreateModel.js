        ...
        <div className="CreateModel-MainContainer">
            <form className="CreateModel-OutlineContainer" onSubmit={handleSubmit}>
                ...
                <div className="CreateModel-InputContainer">
                    ...
                    <input type='text' value={muscularity} onChange={(e) => setMuscularity(e.target.value)} />
                </div>
                <div className="CreateModel-InputContainer">
                    <p className="CreateModel-InputCategoryText">Skinny (1-10): </p>
                    <input type='text' value={skinny} onChange={(e) => setSkinny(e.target.value)} />
                </div>
                <div className="CreateModel-InputContainer">
                    <p className="CreateModel-InputCategoryText">Overweight (1-10): </p>
                    <input type='text' value={overweight} onChange={(e) => setOverweight(e.target.value)} />
                </div>
                <div className="CreateModel-InputContainer">
                    ...
                    >
                        {skinTones.map((color, index) => (
                            <div key={index} style={{ backgroundColor: color, height: 50, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <button type="submit" className="CreateModel-CreateButton">Create!</button>
            </form>
        </div>
    );
}
